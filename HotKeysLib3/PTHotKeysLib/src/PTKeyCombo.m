...
+ (NSDictionary*)_keyCodesDictionary
{
	...
	if( keyCodes == nil )
	{
		...
		contents = [NSString stringWithContentsOfFile: path encoding: NSUTF8StringEncoding error: &theError];
...
- (NSString*)description
{
	...
	#else
		desc = NSLocalizedString( @"(None)", @"Hot Keys: Key Combo text for 'empty' combo" );	// UK 2006-03-14 Changed from NSTLocalizedString
	#endif
	}
